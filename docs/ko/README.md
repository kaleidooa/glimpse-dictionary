...
영어 단어의 한국어 뜻을 읽던 자리에서 확인하는 Chrome 확장입니다. 단어 위에 커서를 두고 **Alt+Shift+D**를 누르면 뜻이 나타나고, 창을 닫을 때까지 해당 단어가 옅게 표시됩니다. 다시 보고 싶은 단어는 단어장에 저장할 수 있습니다.
...
4. 영어 웹페이지에서 단어 위로 커서를 옮긴 뒤 **Alt+Shift+D**를 누르세요. 일반 웹사이트에서는 기본으로 바로 사용할 수 있습니다.
